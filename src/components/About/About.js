      ...
      <div id="about" className="container my-5 pb-5 about-section">
        ...
        <div className="row">
          ...
          <div className="col-sm-12 col-md-6 col-lg-6">
            <div>
              <p className="py-4">
                Hello World! I’m Tahmina Chowdhury. I'm a Front-end Web
                Developer. I have always been interested in web development. I
                love to get new experiences and always learn from my
                surroundings.
                <br />
                <br />
                ...
                Authentication.
                <br />
                <br />I always put quality on top of anything, and whatever
                projects I made were real-life projects. Along with these
                technical skills, I possess good communication skills. I looking
